...
class progress_functions:
    def __init__(self, tabframe, y_pred_proba_mdd, tr, gr):
        super().__init__()
        ...
        self.timer2.timeout.connect(self.progress2)  # 여기에 파라매터 넣으면 안돌아감
        self.timer2.start(15)
        self.timer3 = QtCore.QTimer()
        self.timer3.timeout.connect(self.progress3)  # 여기에 파라매터 넣으면 안돌아감
